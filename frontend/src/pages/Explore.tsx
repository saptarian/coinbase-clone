      ...
      <main className="max-w-screen-2xl mx-auto ring-1 ring-slate-200
        ...
        <section className="flex flex-col gap-1 px-5 mb-1
          ...
          <p className="text-slate-500 md:p-2 md:mb-2
            ">
            Market is down <span className="text-red-600
              ">0.36%</span> (24h)
          </p>
                ...
                <li className="">
                  <a href="#" className="flex items-center gap-3 
                    ...
                    <div className="flex items-center gap-3 flex-grow
                      ...
                      <div className="
                        ">
                        <img src={coinbaseLogo} width="20px" className="
                          " alt=""
                        />
                      </div>
                      <div className="
          ...
          <div className="md:hidden
            ...
            <div className="
              ...
              <a href="/" className="flex hover:bg-slate-100/40 gap-4
                ...
                <div className="">
                  <img src={coinbaseLogo} alt="" width="20px" className="" />
                </div>
                <div className="">
                  <h2 className="font-medium
                    ">Biggest Gainers
                  ...
                  <p className="text-slate-500">
                    Shapeshift FOX Token <span className="text-green-500
                      ">35.84% </span>
                    price change
                  </p>
                </div>

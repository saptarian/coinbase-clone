...
- [Flask-JWT-Extended](https://) for authentication and authorization
- [Flask-Bcrypt](https://) secure user authentication
- [Flask-Cors](https://)
- [gunicorn](https://)

The backend is structured using the [Application Factory Pattern](http://flask.pocoo.org/docs/0.12/patterns/appfactories/). The entry point is the `create_app()` method in `run.py` (`wsgi.py` in production).
